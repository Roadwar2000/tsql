...
SELECT TOP (2000)
    ...
    [Average CPU in seconds] = cast((total_worker_time / (execution_count + 0.0) / 1000000.0) as money),
...
WHERE total_elapsed_time < total_worker_time
	AND total_worker_time / (execution_count + 0.0) > 1000.0 -- average is more than a millisecond
